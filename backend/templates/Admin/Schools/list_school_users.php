        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">User list for</h3>
                    <div class="box-tools">
                ...
                <div class="box-body">
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <th><?php echo $this->Paginator->sort('grade_low', 'Grade Low', array()); ?></th>
                            <th><?php echo $this->Paginator->sort('grade_high', 'Grade High', array()); ?></th>
                            ...
                            <tr>
                                <td>
                                    <div class="checkbox listchkbox">
                                        <label><input type="checkbox" class="userckk"
                                                      data-id="<?php echo $u->id; ?>"></label>
                                    </div>
                                </td>
                                <td><?php echo $u->id; ?></td>
                                <td><?php echo $u->name; ?></td>
                                <td><?php echo $u->grade_low; ?></td>
                                <td><?php echo $u->grade_high; ?></td>
                                <td>
                                <?php
                                if ($u->is_active == 1) { ?>
                                    <a href="<?php echo $this->Url->build('/admin/users/status/' . $u->id . '/0'); ?>"
                                    ...
                                    <a href="<?php echo $this->Url->build('/admin/users/status/' . $u->id . '/1'); ?>"
                                ...
                                <a href="<?php echo $this->Url->build('/admin/schools/edit/' . $u->id); ?>">
                                    <i class="fa fa-eye"></i>
                                </a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" onclick="closeResetPassword()"><span
