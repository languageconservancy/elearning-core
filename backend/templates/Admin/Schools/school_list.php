                            ...
                            <tr>
                                <td>
                                    <div class="checkbox listchkbox">
                                        <label>
                                            <input type="checkbox" class="userckk" data-id="<?php echo $school->id; ?>">
                                        </label>
                                    </div>
                                </td>
                                <td><?php echo $school->id; ?></td>
                                <td><?php echo $school->name; ?></td>
                                <td><?php echo $school->grade_low; ?></td>
                                <td><?php echo $school->grade_high; ?></td>
                                <td>
                                    <a href="<?php echo $this->Url->build('/admin/schools/edit/' . $school->id); ?>">
                                        <i class="fa fa-pencil"></i>
                                    </a>
                                    <?php echo $this->Html->link(
                                        '<i class="fa fa-trash"></i>',
                                        '/admin/schools/delete/' . $school->id,
                                        [
                                            'escape' => false,
                ...
                <div class="box-footer clearfix">
                    <div class="form-group pull-left">
                        <select class="form-control bulkaction">
                            ...
                            <option value="deleteschool">Delete</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="password" class="form-control"
                                id="repassword" placeholder="Conform Password">
                        </div>
                    </div>
                </div>
            </div>
