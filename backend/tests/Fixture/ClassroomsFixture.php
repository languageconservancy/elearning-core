...
class ClassroomsFixture extends TestFixture
{
	...
	public $fields = [
		...
		'teacher_message' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
	...
	public function init(): void
	{
		$this->records = [
			[
				...
				'level_id' => 1,
				'teacher_message' => 'Lorem ipsum dolor sit amet',
				'created_by' => 1,
				'created' => '2020-03-24 13:33:00',
				'modified' => '2020-03-24 13:33:00'
			],
		];
		parent::init();
	}
