...
return [
    ...
    'Datasources' => [
        'default' => [
            ...
            'database' => env('DATABASE_NAME', 'elearning_demo_db'),
            'encoding' => 'utf8',
            'timezone' => 'UTC',
            'flags' => [],
            'cacheMetadata' => true,
        ...
        'test' => [
            ...
            //'port' => 'non_standard_port_number',
            'username' => env('TEST_DATABASE_USERNAME', 'root'),
            'password' => env('TEST_DATABASE_PASSWORD', 'root'),
            'database' => env('TEST_DATABASE_NAME', 'test_elearning_db'),
            'encoding' => 'utf8',
            'timezone' => 'UTC',
            'cacheMetadata' => true,
            'quoteIdentifiers' => false,
    ...
    'AWSBUCKETNAME' => env('AWSBUCKETNAME', ''),
    'CLASSROOMPATHID' => env('CLASSROOMPATHID', 0),
    'AWSREGION' => env('AWSREGION', 'us-west-2'),
    'FROENTEND_LINK' => env('FROENTEND_LINK', 'http://localhost:4200/'),
    'ADMIN_LINK' => env('ADMIN_LINK', 'http://localhost/backend/'),
